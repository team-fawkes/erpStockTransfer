...
@section('content')
    <div class="container-fluid">
        ...
        @endif
        <form method="POST" action="{{ route('stock_transfer_store') }}">
            @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select  name="from_store_id" id="from_store_id" class="form-control" required>
                            ...
                            @foreach($sources as $source)
                                <option value="{{$source->id}}">{{$source->store_name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <td>
                        <select name="product_grade[]" class="form-control">
                            ...
                            @foreach($product_grades as $pg)
                                <option value="{{$pg->id}}">{{$pg->grade}}</option>
                            @endforeach
                        </select>
                    </td>
                    <td><select name="product_name[]" class="form-control"></select></td>
                    <td><select name="product_size[]" class="form-control"></select></td>
                    <td><select name="product_unit[]" class="form-control"></select></td>
                    <td><input type="text" name="product_stock[]" class="form-control" readonly></td>
                    <td><input type="number" step="any" name="quantity[]" class="form-control" required></td>
                    <td><input type="number" step="any" name="rate[]" class="form-control" required ></td>
                    <td><input type="text" name="amount[]" class="form-control" required readonly></td>
